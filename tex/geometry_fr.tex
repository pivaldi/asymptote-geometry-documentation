...
{%
  \noindent\begin{shaded}
    \noindent\begin{tabularx}{\textwidth}{|X}
      ...
      \vspace*{0mm}\BVerbatimInput[commandchars=\\\{\},fontfamily=tt,fontsize=\small]{./include/#1.tex}
    \end{tabularx}
  \end{shaded}
  \stepcounter{example}%
}
...
\def\FVB@Vcolor{\FVB@VerbatimOut{./vcolors/vcolor\thetmpfile.asy}}%
\def\FVE@Vcolor{%
  \FVE@VerbatimOut%
  \ifVcompile\immediate\write18{../bin/pygmentize-wraper.sh ./vcolors/vcolor\thetmpfile}\fi%
  \colorbox{bg-color}{\BVerbatimInput[commandchars=\\\{\},fontfamily=tt,fontsize=\small,baseline=t]{./vcolors/vcolor\thetmpfile.tex}}%
  \stepcounter{tmpfile}%
  \par%
}
