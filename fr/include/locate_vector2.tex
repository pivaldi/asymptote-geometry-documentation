\begin{Verbatim}[commandchars=\\\{\}]
  ...
  \PY{k+kt}{vector} \PY{n}{w}\PY{o}{=}\PY{n+nf}{vector}\PY{p}{(}\PY{n}{R}\PY{p}{,} \PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}\PY{p}{;}
  \PY{n+nf}{show}\PY{p}{(}\PY{l+s}{"\PYZdl{}\PYZbs{}vec\PYZob{}w\PYZcb{}\PYZdl{}"}\PY{p}{,} \PY{n}{w}\PY{p}{,} \PY{n+nf}{linewidth}\PY{p}{(}\PY{n+nv}{bp}\PY{p}{)}\PY{p}{,} \PY{n+nf}{Arrow}\PY{p}{(}\PY{l+m+mi}{3}\PY{n+nv}{mm}\PY{p}{)}\PY{p}{)}\PY{p}{;}
  \PY{n+nf}{dot}\PY{p}{(}\PY{l+s}{"w"}\PY{p}{,} \PY{n}{w}\PY{p}{,} \PY{n+nv}{N}\PY{p}{)}\PY{p}{;} \PY{n+nf}{dot}\PY{p}{(}\PY{l+s}{"point(w)"}\PY{p}{,} \PY{n+nf}{point}\PY{p}{(}\PY{n}{w}\PY{p}{)}\PY{p}{,} \PY{n+nv}{N}\PY{p}{)}\PY{p}{;}
\end{Verbatim}
